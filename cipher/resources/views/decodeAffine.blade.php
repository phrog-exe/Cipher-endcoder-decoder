...
<form id="decodeA" action="/decodeA" method="post">
    ...
    &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp<label class="num3" for="num3">num1:</label><input type="number" id="num3" name="num3" min="1" max="100">
    &nbsp<label class="num4" for="num4">num2:</label><input type="number" id="num4" name="num4" min="1" max="100">&nbsp &nbsp


    <label class="label1" for="text1">Enter text here: </label><br><br>
    <textarea class="area1" name="text1" id="text1" rows="10" cols="50">{{ session('text4') ?? ''}}</textarea>&nbsp &nbsp
    &nbsp
    <textarea class="area2" name="text2" id="text2" rows="10" cols="50">{{session('encodedText4') ?? ''}}</textarea><br><br>
