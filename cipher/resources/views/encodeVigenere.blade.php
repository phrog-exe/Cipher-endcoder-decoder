...
<form id="encodeV" action="/encodeV" method="post">
...
<input type="text" class="key" id="key" name="key" value="enter key here:"><br><br>
    <label class="label1" for="text1">Enter text here: </label><br><br>
    <textarea class="area1" name="text1" id="text1" rows="10" cols="50">{{ session('text5') ?? ''}}</textarea>&nbsp &nbsp
    &nbsp
    <textarea class="area2" name="text2" id="text2" rows="10" cols="50">{{session('encodedText5') ?? ''}}</textarea><br><br>
