...
<form id="decodeV" action="/decodeV" method="post">
    ...
    <textarea class="area1" name="text1" id="text1" rows="10" cols="50">{{ session('text6') ?? ''}}</textarea>&nbsp &nbsp
    &nbsp
    <textarea class="area2" name="text2" id="text2" rows="10" cols="50">{{session('encodedText6') ?? ''}}</textarea><br><br>
