...
<form id="encodeA" action="/encodeA" method="post">
    ...
    &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp<label class="num1" for="num1">num1:</label><input type="number" id="num1" name="num1" min="1" max="100">
    &nbsp<label class="num2" for="num2">num2:</label><input type="number" id="num2" name="num2" min="1" max="100">&nbsp &nbsp


    <label class="label1" for="text1">Enter text here: </label><br><br>
    <textarea class="area1" name="text1" id="text1" rows="10" cols="50">{{ session('text3') ?? ''}}</textarea>&nbsp &nbsp
    &nbsp
    <textarea class="area2" name="text2" id="text2" rows="10" cols="50">{{session('encodedText3') ?? ''}}</textarea><br><br>
